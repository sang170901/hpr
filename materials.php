...
try {
    ...
    $whereClause = "WHERE category = 'vật liệu' AND status = 1";
    $params = [];
    ...
    $categoriesQuery = "SELECT DISTINCT classification FROM products WHERE category = 'vật liệu' AND classification IS NOT NULL ORDER BY classification";
    ...
    <section class="materials-hero">
        <div class="hero-content">
            ...
            <p class="hero-subtitle">
                Khám phá bộ sưu tập vật liệu xây dựng đa dạng từ gỗ, thép, bê tông, gạch đến đá tự nhiên - 
                Chất lượng cao, giá cả cạnh tranh, đáp ứng mọi nhu cầu xây dựng của bạn
            </p>
        </div>
    </section>
        ...
        <div class="search-section">
            <form method="GET" class="search-form">
                <input type="text" name="search" class="search-input" 
                       placeholder="Tìm kiếm vật liệu (tên, mô tả, thương hiệu)..." 
