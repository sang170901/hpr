...
<body>
    ...
    <section class="materials-hero">
        <div class="hero-content">
            <h1 class="hero-title">Cảnh Quan</h1>
            <p class="hero-subtitle">
                Khám phá các sản phẩm cảnh quan đa dạng từ cây xanh, đá trang trí, phụ kiện sân vườn đến hệ thống tưới - 
                Tạo nên không gian xanh hoàn hảo, thân thiện môi trường, nâng cao giá trị công trình
            </p>
        </div>
    </section>
    ...
    <div class="main-content">
        <div class="search-section">
            <form method="GET" class="search-form">
                <input type="text" name="search" class="search-input" 
                       placeholder="Tìm kiếm cảnh quan (tên, mô tả, thương hiệu)..." 
        ...
        <?php if (!empty($search) || !empty($category)): ?>
            <div style="margin-bottom: 2rem; text-align: center;">
                <h2 style="color: #1e293b; margin-bottom: 0.5rem;">
                    Tìm thấy <?php echo $totalItems; ?> sản phẩm cảnh quan
                </h2>
                <?php if ($search): ?>
        ...
        <?php else: ?>
            <div class="no-results">
                ...
                <h3>Không tìm thấy sản phẩm cảnh quan</h3>
