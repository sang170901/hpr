...
try {
    ...
    $whereClause = "WHERE category = 'cảnh quan' AND status = 1";
    $params = [];
    ...
    $categoriesQuery = "SELECT DISTINCT classification FROM products WHERE category = 'cảnh quan' AND classification IS NOT NULL ORDER BY classification";
...
<head>
    ...
    <title>Cảnh Quan Xanh - VNMaterial</title>
...
<section class="landscape-hero">
    <div class="hero-content">
        ...
        <p class="hero-subtitle">
                Thiết kế và thi công cảnh quan xanh chuyên nghiệp - 
                Tạo dựng không gian sống xanh, thân thiện với môi trường, mang lại giá trị thẩm mỹ cao
        </p>
    </div>
</section>
        ...
        <div class="search-section">
            <form method="GET" class="search-form">
                <input type="text" name="search" class="search-input" 
                       placeholder="Tìm kiếm dự án cảnh quan..." 
        ...
        <!-- Results -->
            ...
            <div style="margin-bottom: 2rem; text-align: center;">
                <h2 style="color: #1e293b; margin-bottom: 0.5rem;">
                    Tìm thấy <?php echo $totalItems; ?> dự án cảnh quan
                </h2>
                <?php if ($search): ?>
            ...
            <?php foreach ($landscape as $item): ?>
                <div class="landscape-card">
                        ...
                        <div class="landscape-header">
                            ...
                            <?php else: ?>
                                <div class="landscape-image" style="background: linear-gradient(135deg, #38bdf8 0%, #22d3ee 100%); display: flex; align-items: center; justify-content: center;">
                                    <i class="fas fa-seedling" style="color: white; font-size: 3rem; opacity: 0.7;"></i>
                                </div>
                            <?php endif; ?>
                    </div>
                    ...
                    <div class="landscape-body">
                        <h3 class="landscape-name"><?php echo htmlspecialchars($item['name']); ?></h3>
                            <p class="landscape-description">
                                <?php echo htmlspecialchars(substr($item['description'] ?? 'Dự án cảnh quan xanh chuyên nghiệp', 0, 80)); ?>
                            ...
                            <?php endif; ?>
                                ...
                                <?php if ($item['price']): ?>
                                    <div class="landscape-detail">
                                        ...
                                        <span class="landscape-price"><?php echo number_format($item['price']); ?>đ</span>
                                </div>
                            <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="landscape-footer">
                            <a href="product.php?id=<?php echo $item['id']; ?>" class="view-landscape">
                                <span>Xem chi tiết</span>
                                <i class="fas fa-arrow-right"></i>
                            </a>
                            <span class="landscape-price">
    ...
    <?php if ($totalPages > 1): ?>
        ...
        <?php else: ?>
            <div class="no-results">
                ...
                <h3>Không tìm thấy dự án cảnh quan</h3>
