...
try {
    ...
    $stmt = $pdo->prepare("SELECT * FROM suppliers WHERE id = ? AND status = 1");
    $stmt->execute([$id]);
    ...
    $stmt = $pdo->prepare("
        SELECT id, name, price, featured_image, category, brand, description
        FROM products 
...
<head>
    ...
    <title><?php echo htmlspecialchars($supplier['name']) ?> - VNMaterial</title>
        ...
        <div class="supplier-header">
            <div class="supplier-header-content">
                ...
                <div class="supplier-info">
                    <h1 class="supplier-name"><?php echo htmlspecialchars($supplier['name']) ?></h1>
        ...
        <div class="supplier-content">
            ...
            <div class="content-card">
                ...
                <div class="supplier-description">
                    ...
                    <?php else: ?>
                        <p>Chưa có thông tin giới thiệu về nhà cung cấp này.</p>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <section class="products-section">
            <div class="section-header">
                <h2 class="section-title">
                    ...
                    Sản phẩm từ <?php echo htmlspecialchars($supplier['name']) ?>
                </h2>
            </div>
                ...
                <a href="product-detail.php?id=<?php echo $product['id'] ?>" class="product-card">
                    ...
                    <div class="product-body">
                        ...
                        <div class="product-footer">
                            <span class="view-detail-btn">Xem chi tiết</span>
                        </div>
                    </div>
                </a>
                <?php endforeach; ?>
