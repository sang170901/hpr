    ...
    <section class="materials-hero">
        <div class="hero-content">
            ...
            <p class="hero-subtitle">
                Cập nhật những công nghệ xây dựng tiên tiến nhất từ hệ thống BIM, IoT, AI đến công nghệ xanh - 
                Tối ưu hiệu quả, tiết kiệm chi phí, nâng cao chất lượng công trình
            </p>
        </div>
    </section>
        ...
        <div class="search-section">
            <form method="GET" class="search-form">
                <input type="text" name="search" class="search-input" 
                       placeholder="Tìm kiếm công nghệ (tên, mô tả, thương hiệu)..." 
