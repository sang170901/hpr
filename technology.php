...
try {
    ...
    $whereClause = "WHERE category = 'công nghệ' AND status = 1";
    $params = [];
    ...
    $categoriesQuery = "SELECT DISTINCT classification FROM products WHERE category = 'công nghệ' AND classification IS NOT NULL ORDER BY classification";
...
<section class="technology-hero">
    <div class="hero-content">
        ...
        <p class="hero-subtitle">
                Khám phá giải pháp công nghệ tiên tiến cho ngành xây dựng - 
                Tối ưu hóa quy trình, nâng cao hiệu quả và chất lượng công trình
        </p>
    </div>
</section>
            ...
            <?php foreach ($technology as $item): ?>
                <div class="technology-card">
                        ...
                        <div class="technology-header">
                            ...
                            <?php else: ?>
                                <div class="technology-image" style="background: linear-gradient(135deg, #38bdf8 0%, #22d3ee 100%); display: flex; align-items: center; justify-content: center;">
                    ...
                    <div class="technology-body">
                            ...
                            <?php endif; ?>
                                ...
                                <?php if ($item['price']): ?>
                                    <div class="technology-detail">
                                        ...
                                        <span class="technology-price"><?php echo number_format($item['price']); ?>đ</span>
                                </div>
                            <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="technology-footer">
                            <a href="product.php?id=<?php echo $item['id']; ?>" class="view-technology">
                                <span>Xem chi tiết</span>
                                <i class="fas fa-arrow-right"></i>
                            </a>
                            <span class="technology-price">
    ...
    <?php if ($totalPages > 1): ?>
        ...
        <?php else: ?>
            <div class="no-results">
                ...
                <h3>Không tìm thấy công nghệ</h3>
